...
let huffman = (function() {
  ...
  function wrapSrcFile() {
    ...
    const arbf = new ArrayBuffer(dfLen),
          data = new Uint8Array(arbf);
  ...
  function writeFile(data, fileName) {
    const a = document.createElement('a'),
          b = new Blob([data], {type: 'application/huffman-binary'});
  ...
  function writeHfmFile() {
    let arbf  = new ArrayBuffer(sfLen),  // 这个长度有些大
        data = new Uint8Array(arbf);
    data.fill(0);
